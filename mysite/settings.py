...
# PythonAnywhere - Only this is needed as the above code is placed in the wsgi.py
import os

# PythonAnywhere - Only this is needed as the below code NEED to be placed 
# in the wsgi.py ( By the  Web Tab) for .env to work in the settings
# 19-10-2025 - .env file
# from dotenv import load_dotenv
...
# 18-10-2025 - MySQL settings at Pythonanywhere
...
#STATIC_ROOT = '/home/persteen/mysite/static'
#STATIC_URL = '/static/'
